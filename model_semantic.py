...
class DSMN_SAIM(nn.Module):
    ...
    def forward(self, data, dropout=0.0):
        ...
        for i in range(len(sentences)):
            ...
            specific_aspect_vars.append(aspect_vars_sem[i, :num[i], :])
            specific_sentence_infos.append(sentence_infos_sem[i, :num[i], :, :])
            specific_sentence_locs.append(sentence_locs_sem[i, :num[i], :max_sentence_len])
        ...
        for i in range(len(num)):
            ...
            cur_aspect_loc = aspect_locs_sem[i, :cur_num, :cur_num]
